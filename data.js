...
kw:["didn't report the injury","failed to report injury","didn't report the accident","didnt report unsafe condition","unsafe condition not reported","never filed injury report","reported it too late","didn't tell supervisor about injury","failed to complete injury form"]},
...
// If the app sees these words, it pauses and asks the user for the missing context.
const CLARIFICATIONS = [
  ...
  {
    id: "cancellation_context",
    triggers: ["canceled", "cancelled", "sent home", "no client"],
    q: "When the client canceled, what did the clinic tell you to do?",
    opts: [
      { label: "They sent me home with no other options", append: " The clinic sent me home without offering admin tasks or another client." },
      { label: "They offered tasks, but I declined", append: " The clinic offered me another client but I declined." },
      { label: "I went home without asking", append: " My client canceled and I went home without reporting to the clinic." }
    ]
  }
];
